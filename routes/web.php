...
Route::put('admin/process/bulk-leave-process','AdminController@bulkLeaveRemark');
Route::put('admin/process/filter-leave','AdminController@processFilterLeave');
...
Route::put('admin/process/bulk-overtime-process','AdminController@bulkOvertimeRemark');
