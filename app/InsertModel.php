...
class InsertModel extends Model{
    protected function insertToPersonalInfo($lname,$fname,$mname,$email,$address,$contact,$bday,$cstatus,$user_role,$employment_status,$gender,$department,$job_title,$salary){
		$insert = array(
