			...
			<div class="container-widget">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="request-leave" class="validate-admin form-horizontal" action="<?php echo url('admin/process/add-leave'); ?>" method="post" enctype="multipart/form-data">
								{{ method_field('PUT') }}
								{{ csrf_field() }} 			
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<textarea name="reasons" rows="8" class="form-control"></textarea>
									</div>
								</div>		
								<div class="dropzone">
