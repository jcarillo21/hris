							...
							<form id="edit-applicant" class="validate form-horizontal" action="<?php echo url('admin/process/edit-employee'); ?>" method="post">
								...
								<div class="form-group">
								  <div class="col-sm-6">
										...
										<input value="<?php echo $applicant->username; ?>" placeholder="Username"  type="text" class="form-control" id="username" name="username" required /> extends('includes.admin-template')
	@section('content')
		<div class="page-header">
            <h1 class="title"><?php echo $applicant->fname.' '.$applicant->lname?></h1>
            <ol class="breadcrumb">
