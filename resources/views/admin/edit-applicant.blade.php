						...
						<div class="panel-body">
							<form id="edit-applicant" class="validate form-horizontal" action="<?php echo url('admin/process/edit-employee'); ?>" method="post">
								...
								<div class="form-group">
									 <div class="col-sm-12">
										<label class="control-label form-label">Application Status (Use ctrl + click to select multiple values)</label>
										<select name="application_status[]" class="form-control" multiple>
											<?php if(!empty($applicant->application_status)){ ?>
												<option value="<?php echo $applicant->application_status; ?>" selected><?php echo ucfirst($applicant->application_status); ?></option>
												<option disabled>----</option>
											<?php 
												}else{
													echo '<option selected disabled>--SELECT APPLICATION STATUS--</option>';
												} 
											?>
											<?php
												foreach($helper->application_status() as $text => $value){
								...
								<div class="form-group">
								  ...
								  <div class="col-sm-4">
									...
									<select name="cstatus" class="form-control" >
										<option value="<?php echo $applicant->civil_status; ?>" selected><?php echo ucfirst($applicant->civil_status); ?></option>
										<option disabled>----</option>
										<?php
								  ...
								  <div class="col-sm-4">
									...
									<select name="user_role" class="form-control" required >
										<option value="<?php echo $applicant->user_role; ?>" selected><?php echo ucfirst($applicant->user_role); ?></option>
										<option disabled>----</option>
										<?php
								  ...
								  <div class="col-sm-4">
									...
									<select name="employment_status" class="form-control" >
										<option value="<?php echo $applicant->employment_status; ?>" selected><?php echo ucfirst($applicant->employment_status); ?></option>
										<option disabled>----</option>
										<?php
