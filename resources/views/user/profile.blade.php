						...
						<div class="social-profile">
							<div class="social-top">
							  <div class="profile-left">
								...
								<h1 class="name"><?php echo $profile->fname.' '.$profile->lname; ?> (# <?php echo $profile->employee_id; ?>)</h1>
									...
									<form id="edit-profile" class="validate-user-edit form-horizontal" action="<?php echo url('user/process/edit-profile'); ?>" method="post" >
										...
										<div class="form-group">
										  ...
										  <div class="col-sm-4">
											...
											<p><?php  echo date('M d, Y',strtotime($profile->first_day_of_work)); ?></p>
										  </div>
										  <div class="col-sm-4">
								  ...
								  <div class="panel panel-default">
									...
									<form id="edit-login" class="validate-user-edit form-horizontal" action="<?php echo url('user/process/edit-login'); ?>" method="post" >
										...
										<div class="form-group">
										  ...
										  <div class="panel panel-default">
									<h3>Statutories</h3>
									<form id="edit-statutories" class="form-horizontal" action="<?php echo url('user/process/edit-statutories'); ?>" method="post" >
										{{ method_field('PUT') }}
										{{ csrf_field() }} 								
										<input name="personal_info_id" value="<?php echo $profile->personal_info_id; ?>" type="hidden" />
										<div class="form-group">
