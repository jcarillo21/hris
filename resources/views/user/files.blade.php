...
=======
				<form method="POST" class="dropzone" action="/process/file-upload" enctype="multipart/form-data">
...
=======
														<a data-url="/process/delete-file/'.$file->file_id.'" href="#" class="confirm-delete btn btn-xs btn-danger"><i style="color:#fff; font-size:12px;" class="fa fa-trash-o"></i> Delete</a>
														<a title="Copied!" data-clipboard-text="//'.$_SERVER['HTTP_HOST'].'/files/user/'.Session::get('pid').'/'.$file->file_name.'.'.$file->extension.'" href="#" class="clip btn btn-xs btn-primary"><i style="color:#fff; font-size:12px;" class="fa fa-copy"></i> Copy Link</a>
>>>>>>> b42320356f7f99679c074c7317143e6e872a9658
													</td>
												  </tr>											
												';
